...
const heroSlides = [
  {
    id: 1,
    title: "Un accueil toujours disponible",
    subtitle: "L'équipe municipale vous accueille du lundi au vendredi pour répondre à toutes vos préoccupations.",
    image: "/assets/images/backgrounds/contact-1.jpg",
    alt: "accueil-mairie",
  },
  {
    id: 2,
    title: "Contactez-nous facilement",
    subtitle: "Téléphone, email ou en ligne : plusieurs moyens pour entrer en contact avec la Mairie de Marcory.",
    image: "/assets/images/backgrounds/contact-2.jpg",
    alt: "contact-multicanal",
  },
  {
    id: 3,
    title: "Votre voix compte",
    subtitle: "Exprimez vos suggestions, demandes ou préoccupations via notre plateforme numérique dédiée.",
    image: "/assets/images/backgrounds/contact-3.jpg",
    alt: "voix-citoyenne",
  },
]
