...
export default function Geography(){
    return(
        <div id="geography" className="font-mulish m-8 pb-6">
            ...
            <Link href="#statistic"><div className="bg-gray-300 text-white px-2 md:px-40 py-1 rounded-full md:rounded-b-md hover:bg-gray-400 cursor-pointer text-center">Chiffres clés</div></Link>
            ...
            <Link href="#geography"><div className="bg-primary text-white px-2 md:px-40 py-1 font-medium rounded-full md:rounded-b-md cursor-pointer text-center">Géographie</div></Link>
            </div>
            <div>
