    ...
    return(
        <div className="font-mulish m-8 pb-6">
            <div className="flex flex-col md:flex-row justify-center gap-2 py-4">
                <div className="bg-gray-300 text-white px-2 md:px-40 py-1 rounded-full md:rounded-b-md hover:bg-gray-400 cursor-pointer text-center">Chiffres clés</div>
                ...
                <div className="bg-primary text-white px-2 md:px-40 py-1 font-medium rounded-full md:rounded-b-md cursor-pointer text-center">Géographie</div>
            </div>
            <div>
