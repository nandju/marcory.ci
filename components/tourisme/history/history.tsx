...
export default function History(){
    return(
        <div id="history" className="font-mulish m-8 pb-6">
            ...
            <Link href="#history"><div className="bg-primary text-white px-2 md:px-40 py-1 font-medium rounded-full md:rounded-b-md cursor-pointer text-center">Histoire</div></Link>
