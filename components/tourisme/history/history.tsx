    ...
    return(
        <div className="font-mulish m-8 pb-6">
            <div className="flex flex-row justify-center gap-2 py-4">
                <div className="bg-gray-300 text-white px-40 py-1 rounded-t-md hover:bg-gray-400 cursor-pointer">Chiffres clés</div>
                <div className="bg-primary text-white px-40 py-1 font-medium rounded-t-md cursor-pointer">Histoire</div>
